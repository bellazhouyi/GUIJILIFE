...
{
    return [@{@"filePath": self.filePath==nil?@"":self.filePath,
		@"fileName": self.fileName==nil?@"":self.fileName,
		@"fileAttributes": self.fileAttributes==nil?@"":self.fileAttributes,
		@"creationDate": self.creationDate==nil?@"":self.creationDate,
		@"modificationDate": self.modificationDate==nil?@"":self.modificationDate,
